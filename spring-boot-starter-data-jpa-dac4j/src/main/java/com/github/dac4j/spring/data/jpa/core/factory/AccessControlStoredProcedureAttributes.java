 ...
 * @author Fahd Arhalai
 */
class AccessControlStoredProcedureAttributes {
	...
	private final List<AccessControlProcedureParameter> outputProcedureParameters;

	/**
	 * Creates a new {@link AccessControlStoredProcedureAttributes}.
	 *
	 * @param procedureName must not be {@literal null}.
	 */
	AccessControlStoredProcedureAttributes(String procedureName, AccessControlProcedureParameter parameter) {
	 ...
	 */
	AccessControlStoredProcedureAttributes(String procedureName, List<AccessControlProcedureParameter> outputProcedureParameters,
	...
	private List<AccessControlProcedureParameter> getParametersWithCompletedNames(List<AccessControlProcedureParameter> procedureParameters) {
	...
	private AccessControlProcedureParameter getParameterWithCompletedName(AccessControlProcedureParameter parameter, int i) {

		return new AccessControlProcedureParameter(completeOutputParameterName(i, parameter.getName()), parameter.getMode(),
				parameter.getType());
	}
	 ...
	 */
	public List<AccessControlProcedureParameter> getOutputProcedureParameters() {
